...
const SCOPES = ['https://www.googleapis.com/auth/drive.readonly', 'https://www.googleapis.com/auth/drive.file', 'https://www.googleapis.com/auth/drive'];
...
fs.readFile('credentials.json', (err, content) => {
  ...
  authorize(JSON.parse(content), meetingNotes);
});
